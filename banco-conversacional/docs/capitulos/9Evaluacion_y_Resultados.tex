...
\texttt{fin\_respuesta}, en el que el texto de la respuesta ya está completo. Es
una cota superior de la espera que percibe el usuario, porque la síntesis de voz
empieza antes, con la primera frase recibida. El motor visual se ejecuta después
de ese evento de forma deliberada, así que contabilizar únicamente el tiempo total
