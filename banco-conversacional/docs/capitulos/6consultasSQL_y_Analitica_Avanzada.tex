...
\begin{itemize}
    ...
    El bucle no puede prolongarse indefinidamente: el agente tiene un tope de
    \texttt{MAX\_ITERACIONES\_AGENTE = 8} vueltas por turno, que cuenta todas las
    llamadas a herramientas, incluidas las correcciones.
\end{itemize}

\input{figuras/text_to_sql.tex}
...
La Figura~\ref{fig:recurrencia} compara los dos casos sobre los datos reales del
histórico: Netflix se cobra cada 30 o 31 días, mientras que en una gasolinera se
reposta cuando toca. El hueco entre ambos grupos es amplio, y el umbral cae
dentro de él.

\input{figuras/fig_recurrencia}
