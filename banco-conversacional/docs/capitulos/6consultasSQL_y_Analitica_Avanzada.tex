...
\begin{itemize}
    ...
    \item \textbf{Gestión temporal:} Le indicamos cómo usar funciones nativas como \texttt{strftime} para que no 
    mezcle conceptos. Por ejemplo, le dejamos claro que calcular "este año" natural no se hace igual que buscar 
...
Por eso, apostamos por un enfoque híbrido: la "inteligencia" matemática está programada de forma determinista en Python 
...
a 0,06, y la mediana encaja en una cadencia conocida (mensual, trimestral, anual, etc.) con un margen de 
