...
\begin{itemize}
    \item \textbf{Gastos recurrentes y variables:} se combinan cargos fijos y regulares (como el aquiler, la luz o el agua) con transacciones con alta variabilidad 
    ...
    \item \textbf{Cambios en los gastos:} se simulan subidas de cuota a mitad del histórico, 
...
De esta forma, la base de datos proporciona un conjunto de pruebas variado
